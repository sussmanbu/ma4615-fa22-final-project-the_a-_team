...
toc: true
featuredVideo:
featuredImage: images/Data science.jpeg
draft: false
---
----
...
* In this project, we combined the three datasets (Agriculture, airline, car) by `left_join` and organized them by years. We combined the same columns of the three datasets so that we could analyze and compare the number/content in one dataset.
