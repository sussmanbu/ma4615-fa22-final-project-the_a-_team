...
```{r airline modeling}
air1 <- lm(Emission ~ Year, data = air1)
(beta <- coef(air1))
air1 %>% ggplot(aes(Year, Emission)) + geom_point() +  geom_abline(intercept = beta[1],
              slope = beta[2]) + labs(y = "Emission(tonnes)" )
```
